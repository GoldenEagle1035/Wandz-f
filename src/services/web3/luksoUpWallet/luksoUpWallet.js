...
export const luksoUpWallet = () => ({
  ...
  downloadUrls: {
    ...
    android: "https://lukso.network",
    ios: "https://lukso.network",
  ...
  createConnector: getWalletConnectConnector({ projectId: wandzConfig.walletConnectProjectId })
});
